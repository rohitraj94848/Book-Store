...
router.post("/add-book",authenticateToken,async(req,res) =>{
    try {
        ...
        if(user.role !== "admin"){
            return res.status(400).json({message:"You do not having access to perform admin work"})
        }
...
router.delete("/delete-book", authenticateToken, async (req, res) => {
  ...
  //display of four Book

  router.get("/get-all-books", async (req, res) => {
    try {
        // Fetch all books from the database and sort by createdAt timestamp in descending order
